...
public final class PlaceholderAPIHook extends AbstractHook {
  ...
  private PlaceholderAPIService service;

  public PlaceholderAPIHook(AbstractEconomyPlugin plugin) {
    super(plugin);
  }
  ...
  @Override
  public void load() {
    service = new PlaceholderAPIService(getPlugin().getEconomyPlatform());
  }

  @Override
  public void close() {
    Preconditions.checkState(service.unregister(), "Failed to unregister PlaceholderAPI service");
    service = null;
  }

  private static class PlaceholderAPIService extends PlaceholderExpansion {

    private final EconomyPlatform platform;

    public PlaceholderAPIService(EconomyPlatform platform) {
